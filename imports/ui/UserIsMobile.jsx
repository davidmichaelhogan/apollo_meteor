    ...
    return (
      <div>
        <div className="mobile-user">
          ...
          <div className="mobile-subtitle">Just so you know, Apollo works best on a desktop environment. You may conitinue below, but we suggest you come back when you're on a computer. </div>
